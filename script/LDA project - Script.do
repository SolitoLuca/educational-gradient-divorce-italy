...
logit EVENTO ib2.LIVELLO_ISTRUZ##ib4.COORTE ib1.SESSO ib1.PRIMA_UNIONE i.RIP ib1.PRIMO_LAVORO ib1.PERIODO, or cluster(id)
* Tabella coefficienti interazione:
logit EVENTO ib2.LIVELLO_ISTRUZ#ib4.COORTE ib1.SESSO ib1.PRIMA_UNIONE i.RIP ib1.PRIMO_LAVORO ib1.PERIODO, or cluster(id)
...
* Interazione istruzione dei genitori x coorte dell'unione, escludendo l'istruzione individuale
logit EVENTO ib2.GEN_ISTRUZ#ib4.COORTE ib1.SESSO ib1.PRIMA_UNIONE i.RIP ib1.PRIMO_LAVORO ib1.PERIODO, or cluster(id)  
